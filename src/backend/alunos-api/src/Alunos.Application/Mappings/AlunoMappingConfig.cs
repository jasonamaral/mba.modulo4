...
public class AlunoMappingConfig : IRegister
{
    public void Register(TypeAdapterConfig config)
    {
        ...
        //    .Map(dest => dest.IsAtivo, src => src.Ativo)
        //    .Map(dest => dest.CreatedAt, src => src.DataCriacao)
        //    .Map(dest => dest.UpdatedAt, src => src.DataAlteracao)
        //    .Map(dest => dest.Telefone, src => src.Contato)
        ...
        //    .Ignore(dest => dest.DataAlteracao)
