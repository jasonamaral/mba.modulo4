...
public class AlunoAppService(IAlunoRepository alunoRepository, ILogger<AlunoAppService> logger) : IAlunoAppService
{
    private readonly IAlunoRepository _alunoRepository = alunoRepository;
    private readonly ILogger<AlunoAppService> _logger = logger;
