...
namespace Pagamentos.Core.DomainObjects
{
    public class Validacoes
    {
        ...
        public static void ValidarSeMenorQue(TimeSpan valor, TimeSpan minimo, string mensagem)
        {
            if (valor < minimo)
            {
                throw new DomainException(mensagem);
        ...
        public static void ValidarSeMenorOuIgualQue(TimeSpan valor, TimeSpan minimo, string mensagem)
        {
            if (valor <= minimo)
            {
                throw new DomainException(mensagem);
