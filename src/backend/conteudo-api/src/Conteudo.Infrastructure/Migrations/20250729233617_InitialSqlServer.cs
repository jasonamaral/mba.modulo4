        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConteudoProgramatico_Resumo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConteudoProgramatico_Descricao = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConteudoProgramatico_Objetivos = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConteudoProgramatico_PreRequisitos = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConteudoProgramatico_PublicoAlvo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConteudoProgramatico_Metodologia = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConteudoProgramatico_Recursos = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConteudoProgramatico_Avaliacao = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConteudoProgramatico_Bibliografia = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    Instrutor = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
